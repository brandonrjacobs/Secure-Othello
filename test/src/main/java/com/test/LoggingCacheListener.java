...
public class LoggingCacheListener extends CacheListenerAdapter {
	...
	@Override
	  public void afterCreate(EntryEvent event) {
	    final String myRegion = event.getRegion().getName();
	    final Object key = event.getKey();
	    final Object newValue = event.getNewValue();
	    log.debug("In region [" + myRegion + "] created key [" + key
	        + "] value [" + newValue + "]");
	  }
	  ...
	  public void afterDestroy(EntryEvent event) {
	    final String myRegion = event.getRegion().getName();
	    final Object key = event.getKey();
	    log.debug("In region [" + myRegion + "] destroyed key [" + key
	        + "]");
	  }
	  ...
	  public void afterUpdate(EntryEvent event) {
	    ...
	    log.debug("In region [" + myRegion + "] updated key [" + key
